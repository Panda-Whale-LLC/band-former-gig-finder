  ...
  return (
    <div className="profile-container">
      ...
      <div className="profileinner">
        ...
        <br />
        <div className="pDiv">
          <div id="pLabel">Location: </div>
          {userData.location}
        </div>
        <br />
        <div className="pDiv">
          <div id="pLabel">Contact Email: </div>
          {userData.email}
        </div>
        <br />
        <div className="pDiv">
          <div id="pLabel">Bio: </div>
          {userData.short_bio}
        </div>
        <br />
        {/* extra info (instruments, music, etc) goes here */}
        <div className="pDiv">
          <div id="pLabel">Instrument: </div>
          {userInfo.instrumentation.join(', ')}
          <br />
        </div>
        <br />
        <div className="pDiv">
          <div id="pLabel">Available: </div> {avail}
          <br />
        </div>{' '}
        <br />
        {/* embedded content + social media? */}
        <div className="embedded-content pDiv">
          <div id="pLabel">Social Media: </div>
          {userData.socialmedia_link}
          <br />
          <br />
        ...
        >
          ...
          <input className='submitButton' type="file" id="avatar" name="avatar" accept="image/*" />
          <input type="hidden" name={userInfo.name} value={userInfo.name} />
          <button className="submitButton" id="submitButton" name="submitButton">
            Submit
          </button>
      <button className="submitButton" id="logout" onClick={userLogout}>
          logout
        </button>
        </form>
      </div>
